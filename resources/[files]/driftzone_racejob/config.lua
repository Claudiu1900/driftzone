...
Config.Races = {
    short = {
        ...
        xp = { min = 100, max = 300 },
        cooldown = 5 * 60, -- cooldown dupa castig
        failCooldown = 2 * 60, -- cooldown daca pierde
        timeLimit = 180,
    ...
    special = {
        ...
        label = 'SPECIAL',
        subLabel = 'Duo Race',
        description = 'Fa o cursa impreuna cu prietenul tau si impartiti recompensa finala.',
        special = true,

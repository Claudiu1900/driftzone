# driftzone_admin - complet cu chat commands

Include comenzile:

- `/mute uid minute motiv` - admin_level 2 + aduty
...
Pentru chat lock/mute, `driftzone_chat` trebuie pornit inainte de `driftzone_admin`.

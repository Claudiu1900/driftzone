...
function screenshot() {
    ...
    hint.textContent = 'Se salveaza screenshot-ul pe server...';
    nui('screenshot');
}
...
function updateState(data = {}) {
    ...
    hint.textContent = 'Screenshot: se salveaza in resource/screenshots/model.png.';
}
...
window.addEventListener('message', (event) => {
    ...
    if (data.action === 'shotDone') {
        ...
        hint.textContent = 'Poza a fost procesata. Verifica folderul screenshots.';
    }

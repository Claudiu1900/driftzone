...
author 'DriftZone'
description 'DriftZone Custom Vehicle Sounds'
version '1.0.0'
...
files {
    ...
    -- Shonen
    'audioconfig/shonen_amp.dat10.rel',
...
data_file 'AUDIO_GAMEDATA' 'audioconfig/gt3flat6_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/gt3flat6_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_gt3flat6'

-- K20A
data_file 'AUDIO_SYNTHDATA' 'audioconfig/k20a_amp.dat10.rel'
data_file 'AUDIO_GAMEDATA' 'audioconfig/k20a_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/k20a_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_k20a'

-- Lamborghini V10
data_file 'AUDIO_GAMEDATA' 'audioconfig/lambov10_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/lambov10_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_lambov10'

-- Pagani Huayra M158
data_file 'AUDIO_SYNTHDATA' 'audioconfig/m158huayra_amp.dat10.rel'
data_file 'AUDIO_GAMEDATA' 'audioconfig/m158huayra_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/m158huayra_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_m158huayra'

-- Pagani Zonda M297
data_file 'AUDIO_SYNTHDATA' 'audioconfig/m297zonda_amp.dat10.rel'
data_file 'AUDIO_GAMEDATA' 'audioconfig/m297zonda_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/m297zonda_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_m297zonda'

-- Muscle V8
data_file 'AUDIO_GAMEDATA' 'audioconfig/musv8_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/musv8_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_musv8'

-- P60B40
data_file 'AUDIO_GAMEDATA' 'audioconfig/p60b40_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/p60b40_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_p60b40'

-- Predator V8
data_file 'AUDIO_GAMEDATA' 'audioconfig/predatorv8_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/predatorv8_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_predatorv8'

-- RB26DETT
data_file 'AUDIO_SYNTHDATA' 'audioconfig/rb26dett_amp.dat10.rel'
data_file 'AUDIO_GAMEDATA' 'audioconfig/rb26dett_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/rb26dett_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_rb26dett'

-- Rotary 7
data_file 'AUDIO_GAMEDATA' 'audioconfig/rotary7_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/rotary7_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_rotary7'

-- Shonen
data_file 'AUDIO_SYNTHDATA' 'audioconfig/shonen_amp.dat10.rel'
data_file 'AUDIO_GAMEDATA' 'audioconfig/shonen_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/shonen_sounds.dat54.rel'
data_file 'AUDIO_WAVEPACK' 'sfx/dlc_shonen'

-- Toyota Supra MK4
data_file 'AUDIO_GAMEDATA' 'audioconfig/toysupmk4_game.dat151.rel'
data_file 'AUDIO_SOUNDDATA' 'audioconfig/toysupmk4_sounds.dat54.rel'
